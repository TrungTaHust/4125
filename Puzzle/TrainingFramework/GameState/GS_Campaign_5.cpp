...
void GSCampaign5::Init()
{
	auto background = SceneManager::GetInstance()->GetObjectByID("map5");
...
void GSCampaign5::GunUpdate(float deltaTime)
{
	if (isBulletOut) {
...
void GSCampaign5::AlienUpdate(float deltaTime)
{
...
void GSCampaign5::BulletUpdate(float deltaTime)
{
...
void GSCampaign5::Update(float deltaTime)
{
...
void GSCampaign5::HandleEvents()
{
}

void GSCampaign5::HandleKeyEvents(int key, bool bIsPressed)
{
...
void GSCampaign5::HandleTouchEvents(float x, float y, bool bIsPressed)
{
...
void GSCampaign5::HandleMouseMoveEvents(float x, float y)
{
	for (auto& button : m_buttonList)
	{
...
void GSCampaign5::Spawn(const char* type)
{
...
void GSCampaign5::SpawnByDifficult(float deltaTime) {
	m_time -= deltaTime;
	if (m_time <= 0) {
		m_time += 1;
