...
void GSCampaign3::Init()
{
	auto background = SceneManager::GetInstance()->GetObjectByID("map3");
...
void GSCampaign3::GunUpdate(float deltaTime)
{
	if (isBulletOut) {
...
void GSCampaign3::AlienUpdate(float deltaTime)
{
...
void GSCampaign3::BulletUpdate(float deltaTime)
{
...
void GSCampaign3::Update(float deltaTime)
{
...
void GSCampaign3::HandleEvents()
{
}

void GSCampaign3::HandleKeyEvents(int key, bool bIsPressed)
{
...
void GSCampaign3::HandleTouchEvents(float x, float y, bool bIsPressed)
{
...
void GSCampaign3::HandleMouseMoveEvents(float x, float y)
{
	for (auto& button : m_buttonList)
	{
...
void GSCampaign3::Spawn(const char* type)
{
...
void GSCampaign3::SpawnByDifficult(float deltaTime) {
	m_time -= deltaTime;
	if (m_time <= 0) {
		m_time += 1;
